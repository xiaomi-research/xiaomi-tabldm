...
class InferenceManager:
    ...
    def configure(
        ...
        use_fa3 : bool, default=True
            Whether to use the FlashAttention fast path during inference. Despite the
            legacy name, FlashAttention-3 is preferred when installed and falls back to
            FlashAttention-2; this can improve performance for large sequences but may be
            slower for small datasets. Effective only when a flash_attn package is
            installed.
